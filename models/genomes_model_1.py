...
print('\nPreprocessing and modelling complete genomes of single stranded DNA viruses:\n target = Geminiviridae\n')

# Load the padded and encoded series of sequences
print('loading')
X1 = np.load('genome_array_X1.npy')
y1 = np.load('genome_array_y1.npy')
print('done')
...
model_1.fit(X1_train, y1_train, validation_data = (X1_test, y1_test), epochs = 15)
